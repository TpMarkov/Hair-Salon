    ...
    <section ref={containerRef} className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {[...services].reverse().map((item, index) => (
          ...
          >
            <div className="relative overflow-hidden rounded-2xl aspect-[4/5] mb-4 shadow-xl transition-all duration-500 group-hover:shadow-gold/20 group-hover:-translate-y-2">
              <img
                src={item.image}
                alt={item.type}
            ...
            <div className="px-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-400 text-sm">Професионална грижа</span>
